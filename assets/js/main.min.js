...
if (serviceItems) {
  ...
  serviceItems.forEach(function (serviceItem) {
    serviceItem.addEventListener('click', function (e) {
      var serviceCate = serviceItem.parentElement.parentElement.parentElement.parentElement;
...
if (addToCartBtn) {
  ...
  addToCartBtn.addEventListener('click', function () {
    // Get product infor
    var prdName = document.querySelector('.name').innerHTML;
    var prdPrice = document.querySelector('.price').innerHTML;
    var prdImg = document.querySelector('.bg-img img').getAttribute('src');
    var prdQuantity = document.querySelector('.prd-quantity .quantity-block span').innerHTML;
...
if (increaseNumberCarts && document.querySelector('.cart-block')) {
  increaseNumberCarts.forEach(function (increaseNumberCart) {
    ...
    increaseNumberCart.addEventListener('click', function (e) {
      ...
      var productItem = parentItem.parentElement.parentElement;
      var pricePrd = productItem.querySelector('span.price').innerHTML;
      var totalPricePrdItem = productItem.querySelector('span.total');
      ...
      arrayPrd.forEach(function (item) {
        var total = item.querySelector('span.total');
...
var formLoginHeading = document.querySelector('.checkout-block .form-login-block');
var loginHeading = document.querySelector('.checkout-block .login .left span.text-button');
var iconDownHeading = document.querySelector('.checkout-block .login .right i');
if (loginHeading) {
...
var paymentType = document.querySelectorAll('.payment-block .list-payment .type');
