...
var animateTextSlider3 = function animateTextSlider3() {
  ...
  textHeadings.forEach(function (textItem) {
    ...
    characters.forEach(function (_char, index) {
      ...
      if (index < 4) {
        span.classList.add('animate__animated', 'animate__fadeIn', "animate__delay-0-".concat((index + 1) * 2, "s")); // Thêm class 'highlighted'
      }

      if (index >= 4) {
        span.classList.add('animate__animated', 'animate__fadeIn', "animate__delay-1-".concat((index + 1) * 2 % 10, "s")); // Thêm class 'highlighted'
      }

      if (index >= 9) {
        span.classList.add('animate__animated', 'animate__fadeIn', "animate__delay-2-".concat((index + 1) * 2 % 20, "s")); // Thêm class 'highlighted'
      }
...
var listTestimonialBlock = document.querySelector('.list-testimonials-block');
...
if (document.querySelector('.checkout-block-main')) {
  ...
  if (cartStore && cartStore.length > 0) {
    ...
    document.querySelector('.total-block .total-product').innerHTML = "$".concat(totalCheckOut, ".00");
    var discountCheckout = document.querySelector('.discount-block span.discount').innerHTML;
    document.querySelector('.total-cart-block .total-cart').innerHTML = "$".concat(Number(totalCheckOut - discountCheckout), ".00");
  } else {
