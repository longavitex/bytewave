...
// Change cursor
var listNews = document.querySelector('.section-news .list-news .slick-list');
var mouseCursor = document.querySelector('.cursor');
if (listNews) {
  listNews.addEventListener('mousemove', function (e) {
    mouseCursor.style.top = e.pageY + 'px';
    mouseCursor.style.left = e.pageX + 'px';
    mouseCursor.style.opacity = '1';
  });
  listNews.addEventListener('mouseout', function (e) {
    mouseCursor.style.opacity = '0';
  });
  listNews.addEventListener('mousedown', function () {
    mouseCursor.style.width = '60px';
    mouseCursor.style.height = '60px';
    mouseCursor.style.gap = '4px';
  });
  listNews.addEventListener('mouseup', function () {
...
var playBtn = document.querySelector('.video-block i.ph-play');
